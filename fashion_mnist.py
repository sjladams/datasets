...
from .utils import FlattenTransform, ClassificationDataset


def load_fashion_mnist(train: bool = True, len_dataset: int = 60000, flatten: bool = True, paths: bool = False,
                       **kwargs) -> Tuple[Dataset, torch.Size, torch.Size]:
    root = '{}/{}'.format(os.path.dirname(__file__), '/fashion_mnist')
